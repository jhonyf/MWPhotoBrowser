...
- (void)layoutVisiblePages {
    ...
    for (MWZoomingScrollView *page in _visiblePages) {
        ...
        if (page.avPlayerLayer) {
            page.avPlayerLayer.frame = page.frame;
        }
...
- (void)tilePages {
    ...
    for (MWZoomingScrollView *page in _visiblePages) {
        ...
        if (pageIndex < (NSUInteger)iFirstIndex || pageIndex > (NSUInteger)iLastIndex) {
            ...
            [page.avPlayerLayer removeFromSuperlayer];
...
- (void)_playVideo:(NSURL *)videoURL atPhotoIndex:(NSUInteger)index {
    ...
    _currentVideoPlayer = [[AVPlayer alloc] initWithPlayerItem:_currentVideoPlayerItem];
    ...
    // Show
    [[self pageDisplayedAtIndex:index].avPlayerLayer setPlayer: _currentVideoPlayer];
